...
class ResNet(nn.Module):
    ...
    def __init__(self, params, block, stages, num_classes=3, zero_init_residual=False, groups=1, width_per_group=64):
...
def resnet18(params, pretrained=False, **kwargs):
    model = ResNet(params, Identity_block, [2, 2, 2, 2], **kwargs)
...
def resnet34(params, pretrained=False, **kwargs):
    model = ResNet(params, Identity_block, [3, 4, 6, 3], **kwargs)
...
"""
    create resnet50
"""
def resnet50(params, pretrained=False, **kwargs):
    model = ResNet(params, Conv_block, [3, 4, 6, 3], **kwargs)
...
def resnet101(params, pretrained=False, **kwargs):
    model = ResNet(params, Conv_block, [3, 4, 23, 3], **kwargs)
...
def resnet152(params, pretrained=False, **kwargs):
    model = ResNet(params, Conv_block, [3, 8, 36, 3], **kwargs)
